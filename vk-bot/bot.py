import asyncio, aiohttp, json, time, datetime, logging
...
class Bot:
    ...
    async def callback_processor(self, request):
        try:
            ...
            print('UnicodeDecodeError or ValueError. {}'.format(datetime.datetime.now()))
    ...
    def callback_run(self, custom_process=False):
        ...
        self.logger.info("Started to process messages")
        self.logger.info('HOST = {} PORT = {}'.format(host, port))
